...
FROM (SELECT insurance_users_a6_0.FIRST_NAME AS COL0, insurance_users_a6_0.LAST_NAME AS COL1, insurance_users_a6_0.ADDRESS AS COL2, insurance_users_a6_0.BIRTHDATE AS COL3 
  ...
  BEGIN
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'dejima_insurance_delta_action_flag') THEN
        ...
        CREATE TEMPORARY TABLE Δ_del_insurance_users WITH OIDS ON COMMIT DROP AS SELECT (ROW(COL0,COL1,COL2,COL3,COL4,COL5) :: public.insurance_users).* 
            FROM (SELECT Δ_del_insurance_users_a6_0.COL0 AS COL0, Δ_del_insurance_users_a6_0.COL1 AS COL1, Δ_del_insurance_users_a6_0.COL2 AS COL2, Δ_del_insurance_users_a6_0.COL3 AS COL3, Δ_del_insurance_users_a6_0.COL4 AS COL4, Δ_del_insurance_users_a6_0.COL5 AS COL5 
FROM (SELECT insurance_users_a6_0.ID AS COL0, insurance_users_a6_0.FIRST_NAME AS COL1, insurance_users_a6_0.LAST_NAME AS COL2, insurance_users_a6_0.INSURANCE_NUMBER AS COL3, insurance_users_a6_0.ADDRESS AS COL4, insurance_users_a6_0.BIRTHDATE AS COL5 
...
WHERE new_dejima_insurance_a4.COL3 = insurance_users_a6_0.BIRTHDATE AND new_dejima_insurance_a4.COL2 = insurance_users_a6_0.ADDRESS AND new_dejima_insurance_a4.COL1 = insurance_users_a6_0.LAST_NAME AND new_dejima_insurance_a4.COL0 = insurance_users_a6_0.FIRST_NAME ) ) AS Δ_del_insurance_users_a6_0  ) AS Δ_del_insurance_users_extra_alias;
...
CREATE TEMPORARY TABLE Δ_ins_insurance_users WITH OIDS ON COMMIT DROP AS SELECT (ROW(COL0,COL1,COL2,COL3,COL4,COL5) :: public.insurance_users).* 
            FROM (SELECT Δ_ins_insurance_users_a6_0.COL0 AS COL0, Δ_ins_insurance_users_a6_0.COL1 AS COL1, Δ_ins_insurance_users_a6_0.COL2 AS COL2, Δ_ins_insurance_users_a6_0.COL3 AS COL3, Δ_ins_insurance_users_a6_0.COL4 AS COL4, Δ_ins_insurance_users_a6_0.COL5 AS COL5 
...
FROM (SELECT 0 AS COL0    UNION SELECT insurance_users_a6_0.ID AS COL0 
FROM public.insurance_users AS insurance_users_a6_0  ) AS all_ids_a1_0   ) AS current_max_id_a1_1 
WHERE NOT EXISTS ( SELECT * 
FROM public.insurance_users AS insurance_users_a6 
WHERE insurance_users_a6.BIRTHDATE = new_dejima_insurance_a4_0.COL3 AND insurance_users_a6.ADDRESS = new_dejima_insurance_a4_0.COL2 AND insurance_users_a6.LAST_NAME = new_dejima_insurance_a4_0.COL1 AND insurance_users_a6.FIRST_NAME = new_dejima_insurance_a4_0.COL0 ) ) AS Δ_ins_insurance_users_a6_0  ) AS Δ_ins_insurance_users_extra_alia 
            EXCEPT 
            SELECT * FROM  public.insurance_users; 

FOR temprecΔ_del_insurance_users IN ( SELECT * FROM Δ_del_insurance_users) LOOP 
            DELETE FROM public.insurance_users WHERE ROW(ID,FIRST_NAME,LAST_NAME,INSURANCE_NUMBER,ADDRESS,BIRTHDATE) =  temprecΔ_del_insurance_users;
            END LOOP;
...
AS $$
  ...
  BEGIN
    mappping = 
'{
  dejima_insurance.FIRST_NAME: insurance_users.FIRST_NAME,
  dejima_insurance.LAST_NAME: insurance_users.LAST_NAME,
  dejima_insurance.ADDRESS: insurance_users.ADDRESS,
  dejima_insurance.BIRTHDATE: insurance_users.BIRTHDATE
}';
    RETURN mappping;
  END;
$$;
