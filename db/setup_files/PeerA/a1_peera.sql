...
p_0(ID, VID, LOCATION, RID) :- bt(ID, VID, LOCATION, RID).
*/
...
FROM (SELECT bt_a4_0.ID AS COL0, bt_a4_0.VID AS COL1, bt_a4_0.LOCATION AS COL2, bt_a4_0.RID AS COL3 
...
BEGIN
    ...
    END IF;
    DELETE FROM __temp__Δ_del_bt_for_a1 WHERE ROW(ID,VID,LOCATION,RID) = NEW;
    INSERT INTO __temp__Δ_ins_bt_for_a1 SELECT (NEW).*; 
    ELSIF TG_OP = 'UPDATE' THEN
    IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN 
        RAISE check_violation USING MESSAGE = 'Invalid update: null value is not accepted';
    END IF;
    DELETE FROM __temp__Δ_ins_bt_for_a1 WHERE ROW(ID,VID,LOCATION,RID) = OLD;
...
FROM (SELECT p_0_a4_0.COL0 AS COL0, p_0_a4_0.COL1 AS COL1, p_0_a4_0.COL2 AS COL2, p_0_a4_0.COL3 AS COL3 
FROM (SELECT __temp__Δ_ins_bt_for_a1_a4_0.ID AS COL0, __temp__Δ_ins_bt_for_a1_a4_0.VID AS COL1, __temp__Δ_ins_bt_for_a1_a4_0.LOCATION AS COL2, __temp__Δ_ins_bt_for_a1_a4_0.RID AS COL3 
...
FROM (SELECT p_0_a4_0.COL0 AS COL0, p_0_a4_0.COL1 AS COL1, p_0_a4_0.COL2 AS COL2, p_0_a4_0.COL3 AS COL3 
FROM (SELECT __temp__Δ_del_bt_for_a1_a4_0.ID AS COL0, __temp__Δ_del_bt_for_a1_a4_0.VID AS COL1, __temp__Δ_del_bt_for_a1_a4_0.LOCATION AS COL2, __temp__Δ_del_bt_for_a1_a4_0.RID AS COL3 
FROM __temp__Δ_del_bt_for_a1 AS __temp__Δ_del_bt_for_a1_a4_0  ) AS p_0_a4_0  ) AS ∂_del_a1_a4_0  ) AS __dummy__) as t);
        ...
        IF (insertion_data IS DISTINCT FROM '[]') OR (deletion_data IS DISTINCT FROM '[]') THEN 
            ...
            IF NOT (user_name = 'dejima') THEN 
                ...
                json_data := concat('{"xid": "PeerA_', xid, '_a1" ,"view": ' , '"public.a1"', ', ' , '"insertions": ' , insertion_data , ', ' , '"deletions": ' , deletion_data , '}');
...
WHERE new_a1_a4.COL3 = bt_a4_0.RID AND new_a1_a4.COL2 = bt_a4_0.LOCATION AND new_a1_a4.COL1 = bt_a4_0.VID AND new_a1_a4.COL0 = bt_a4_0.ID ) ) AS Δ_del_bt_a4_0  ) AS Δ_del_bt_extra_alias;
...
WHERE bt_a4.RID = new_a1_a4_0.COL3 AND bt_a4.LOCATION = new_a1_a4_0.COL2 AND bt_a4.VID = new_a1_a4_0.COL1 AND bt_a4.ID = new_a1_a4_0.COL0 ) ) AS Δ_ins_bt_a4_0  ) AS Δ_ins_bt_extra_alia 
            EXCEPT 
            SELECT * FROM  public.bt; 

FOR temprecΔ_del_bt IN ( SELECT * FROM Δ_del_bt) LOOP 
            DELETE FROM public.bt WHERE ROW(ID,VID,LOCATION,RID) =  temprecΔ_del_bt;
            END LOOP;
DROP TABLE Δ_del_bt;
