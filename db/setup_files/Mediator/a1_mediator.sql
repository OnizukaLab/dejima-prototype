...
BEGIN
    ...
    END IF;
    DELETE FROM __temp__Δ_del_bt_for_a1 WHERE ROW(DEJIMA_ID,VID,LOCATION,RID,PROVIDER) = NEW;
    INSERT INTO __temp__Δ_ins_bt_for_a1 SELECT (NEW).*; 
    ELSIF TG_OP = 'UPDATE' THEN
    IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN 
        RAISE check_violation USING MESSAGE = 'Invalid update: null value is not accepted';
    END IF;
    DELETE FROM __temp__Δ_ins_bt_for_a1 WHERE ROW(DEJIMA_ID,VID,LOCATION,RID,PROVIDER) = OLD;
...
FROM (SELECT p_0_a4_0.COL0 AS COL0, p_0_a4_0.COL1 AS COL1, p_0_a4_0.COL2 AS COL2, p_0_a4_0.COL3 AS COL3 
FROM (SELECT __temp__Δ_ins_bt_for_a1_a5_0.DEJIMA_ID AS COL0, __temp__Δ_ins_bt_for_a1_a5_0.VID AS COL1, __temp__Δ_ins_bt_for_a1_a5_0.LOCATION AS COL2, __temp__Δ_ins_bt_for_a1_a5_0.RID AS COL3 
...
FROM (SELECT __temp__bt_for_a1_a5_0.DEJIMA_ID AS COL0, __temp__bt_for_a1_a5_0.LOCATION AS COL1, __temp__bt_for_a1_a5_0.RID AS COL2, __temp__bt_for_a1_a5_0.VID AS COL3 
FROM __temp__bt_for_a1 AS __temp__bt_for_a1_a5_0 
WHERE __temp__bt_for_a1_a5_0.PROVIDER = 'A' ) AS p_1_a4 
WHERE p_1_a4.COL3 = __temp__Δ_ins_bt_for_a1_a5_0.VID AND p_1_a4.COL2 = __temp__Δ_ins_bt_for_a1_a5_0.RID AND p_1_a4.COL1 = __temp__Δ_ins_bt_for_a1_a5_0.LOCATION AND p_1_a4.COL0 = __temp__Δ_ins_bt_for_a1_a5_0.DEJIMA_ID ) ) AS p_0_a4_0  ) AS ∂_ins_a1_a4_0  ) AS __dummy__) as t);
        IF insertion_data IS NOT DISTINCT FROM NULL THEN 
            insertion_data := '[]';
        END IF; 
...
FROM (SELECT p_0_a4_0.COL0 AS COL0, p_0_a4_0.COL1 AS COL1, p_0_a4_0.COL2 AS COL2, p_0_a4_0.COL3 AS COL3 
FROM (SELECT __temp__Δ_del_bt_for_a1_a5_0.DEJIMA_ID AS COL0, __temp__Δ_del_bt_for_a1_a5_0.VID AS COL1, __temp__Δ_del_bt_for_a1_a5_0.LOCATION AS COL2, __temp__Δ_del_bt_for_a1_a5_0.RID AS COL3 
...
FROM (SELECT __temp__Δ_ins_bt_for_a1_a5_0.PROVIDER AS COL0, __temp__Δ_ins_bt_for_a1_a5_0.DEJIMA_ID AS COL1, __temp__Δ_ins_bt_for_a1_a5_0.LOCATION AS COL2, __temp__Δ_ins_bt_for_a1_a5_0.RID AS COL3, __temp__Δ_ins_bt_for_a1_a5_0.VID AS COL4 
FROM __temp__Δ_ins_bt_for_a1 AS __temp__Δ_ins_bt_for_a1_a5_0   UNION SELECT __temp__bt_for_a1_a5_0.PROVIDER AS COL0, __temp__bt_for_a1_a5_0.DEJIMA_ID AS COL1, __temp__bt_for_a1_a5_0.LOCATION AS COL2, __temp__bt_for_a1_a5_0.RID AS COL3, __temp__bt_for_a1_a5_0.VID AS COL4 
FROM __temp__bt_for_a1 AS __temp__bt_for_a1_a5_0 
WHERE NOT EXISTS ( SELECT * 
FROM __temp__Δ_del_bt_for_a1 AS __temp__Δ_del_bt_for_a1_a5 
WHERE __temp__Δ_del_bt_for_a1_a5.PROVIDER = __temp__bt_for_a1_a5_0.PROVIDER AND __temp__Δ_del_bt_for_a1_a5.RID = __temp__bt_for_a1_a5_0.RID AND __temp__Δ_del_bt_for_a1_a5.LOCATION = __temp__bt_for_a1_a5_0.LOCATION AND __temp__Δ_del_bt_for_a1_a5.VID = __temp__bt_for_a1_a5_0.VID AND __temp__Δ_del_bt_for_a1_a5.DEJIMA_ID = __temp__bt_for_a1_a5_0.DEJIMA_ID ) ) AS p_2_a5_0 
WHERE p_2_a5_0.COL0 = 'A' ) AS p_1_a4 
WHERE p_1_a4.COL3 = __temp__Δ_del_bt_for_a1_a5_0.VID AND p_1_a4.COL2 = __temp__Δ_del_bt_for_a1_a5_0.RID AND p_1_a4.COL1 = __temp__Δ_del_bt_for_a1_a5_0.LOCATION AND p_1_a4.COL0 = __temp__Δ_del_bt_for_a1_a5_0.DEJIMA_ID ) ) AS p_0_a4_0  ) AS ∂_del_a1_a4_0  ) AS __dummy__) as t);
        IF deletion_data IS NOT DISTINCT FROM NULL THEN 
            deletion_data := '[]';
        END IF; 
        IF (insertion_data IS DISTINCT FROM '[]') OR (deletion_data IS DISTINCT FROM '[]') THEN 
...
WHERE __temp__Δ_del_bt_for_a1_a5.PROVIDER = __temp__bt_for_a1_a5_0.PROVIDER AND __temp__Δ_del_bt_for_a1_a5.RID = __temp__bt_for_a1_a5_0.RID AND __temp__Δ_del_bt_for_a1_a5.LOCATION = __temp__bt_for_a1_a5_0.LOCATION AND __temp__Δ_del_bt_for_a1_a5.VID = __temp__bt_for_a1_a5_0.VID AND __temp__Δ_del_bt_for_a1_a5.DEJIMA_ID = __temp__bt_for_a1_a5_0.DEJIMA_ID ) ) AS p_2_a5_0 
WHERE p_2_a5_0.COL0 = 'A' ) AS p_1_a4 
WHERE p_1_a4.COL3 = __temp__Δ_del_bt_for_a1_a5_0.VID AND p_1_a4.COL2 = __temp__Δ_del_bt_for_a1_a5_0.RID AND p_1_a4.COL1 = __temp__Δ_del_bt_for_a1_a5_0.LOCATION AND p_1_a4.COL0 = __temp__Δ_del_bt_for_a1_a5_0.DEJIMA_ID ) ) AS p_0_a4_0  ) AS ∂_del_a1_a4_0  ) AS __dummy__;
...
FROM __temp__bt_for_a1 AS __temp__bt_for_a1_a5_0 
WHERE __temp__bt_for_a1_a5_0.PROVIDER = 'A' ) AS p_1_a4 
WHERE p_1_a4.COL3 = __temp__Δ_ins_bt_for_a1_a5_0.VID AND p_1_a4.COL2 = __temp__Δ_ins_bt_for_a1_a5_0.RID AND p_1_a4.COL1 = __temp__Δ_ins_bt_for_a1_a5_0.LOCATION AND p_1_a4.COL0 = __temp__Δ_ins_bt_for_a1_a5_0.DEJIMA_ID ) ) AS p_0_a4_0  ) AS ∂_ins_a1_a4_0  ) AS __dummy__;
            END IF;
        END IF;
    END IF;
END IF;
