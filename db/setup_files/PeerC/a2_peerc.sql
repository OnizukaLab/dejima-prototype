...
/*view definition (get):
a2(ID, VID, LOCATION, RID) :- p_0(ID, VID, LOCATION, RID).
p_0(ID, VID, LOCATION, RID) :- COL4 = 'True' , bt(ID, VID, LOCATION, RID, COL4).
*/

CREATE OR REPLACE VIEW public.a2 AS 
SELECT __dummy__.COL0 AS ID,__dummy__.COL1 AS VID,__dummy__.COL2 AS LOCATION,__dummy__.COL3 AS RID 
...
FROM (SELECT bt_a5_0.ID AS COL0, bt_a5_0.VID AS COL1, bt_a5_0.LOCATION AS COL2, bt_a5_0.RID AS COL3 
FROM public.bt AS bt_a5_0 
WHERE bt_a5_0.SHARABLE = 'True' ) AS p_0_a4_0  ) AS a2_a4_0  ) AS __dummy__;
...
BEGIN
    ...
    END IF;
    DELETE FROM __temp__Δ_del_bt_for_a2 WHERE ROW(ID,VID,LOCATION,RID,SHARABLE) = NEW;
    INSERT INTO __temp__Δ_ins_bt_for_a2 SELECT (NEW).*; 
    ELSIF TG_OP = 'UPDATE' THEN
    IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN 
        RAISE check_violation USING MESSAGE = 'Invalid update: null value is not accepted';
    END IF;
    DELETE FROM __temp__Δ_ins_bt_for_a2 WHERE ROW(ID,VID,LOCATION,RID,SHARABLE) = OLD;
...
IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'bt_detect_update_on_a2_flag') THEN
    ...
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'a2_delta_action_flag') THEN
        insertion_data := (SELECT (array_to_json(array_agg(t)))::text FROM (SELECT __dummy__.COL0 AS ID,__dummy__.COL1 AS VID,__dummy__.COL2 AS LOCATION,__dummy__.COL3 AS RID 
FROM (SELECT ∂_ins_a2_a4_0.COL0 AS COL0, ∂_ins_a2_a4_0.COL1 AS COL1, ∂_ins_a2_a4_0.COL2 AS COL2, ∂_ins_a2_a4_0.COL3 AS COL3 
FROM (SELECT p_0_a4_0.COL0 AS COL0, p_0_a4_0.COL1 AS COL1, p_0_a4_0.COL2 AS COL2, p_0_a4_0.COL3 AS COL3 
FROM (SELECT __temp__Δ_ins_bt_for_a2_a5_0.ID AS COL0, __temp__Δ_ins_bt_for_a2_a5_0.VID AS COL1, __temp__Δ_ins_bt_for_a2_a5_0.LOCATION AS COL2, __temp__Δ_ins_bt_for_a2_a5_0.RID AS COL3 
FROM __temp__Δ_ins_bt_for_a2 AS __temp__Δ_ins_bt_for_a2_a5_0 
WHERE __temp__Δ_ins_bt_for_a2_a5_0.SHARABLE = 'True' AND NOT EXISTS ( SELECT * 
FROM (SELECT __temp__bt_for_a2_a5_0.ID AS COL0, __temp__bt_for_a2_a5_0.LOCATION AS COL1, __temp__bt_for_a2_a5_0.RID AS COL2, __temp__bt_for_a2_a5_0.VID AS COL3 
FROM __temp__bt_for_a2 AS __temp__bt_for_a2_a5_0 
WHERE __temp__bt_for_a2_a5_0.SHARABLE = 'True' ) AS p_1_a4 
WHERE p_1_a4.COL3 = __temp__Δ_ins_bt_for_a2_a5_0.VID AND p_1_a4.COL2 = __temp__Δ_ins_bt_for_a2_a5_0.RID AND p_1_a4.COL1 = __temp__Δ_ins_bt_for_a2_a5_0.LOCATION AND p_1_a4.COL0 = __temp__Δ_ins_bt_for_a2_a5_0.ID ) ) AS p_0_a4_0  ) AS ∂_ins_a2_a4_0  ) AS __dummy__) as t);
        IF insertion_data IS NOT DISTINCT FROM NULL THEN 
            insertion_data := '[]';
        END IF; 
        deletion_data := (SELECT (array_to_json(array_agg(t)))::text FROM (SELECT __dummy__.COL0 AS ID,__dummy__.COL1 AS VID,__dummy__.COL2 AS LOCATION,__dummy__.COL3 AS RID 
FROM (SELECT ∂_del_a2_a4_0.COL0 AS COL0, ∂_del_a2_a4_0.COL1 AS COL1, ∂_del_a2_a4_0.COL2 AS COL2, ∂_del_a2_a4_0.COL3 AS COL3 
FROM (SELECT p_0_a4_0.COL0 AS COL0, p_0_a4_0.COL1 AS COL1, p_0_a4_0.COL2 AS COL2, p_0_a4_0.COL3 AS COL3 
FROM (SELECT __temp__Δ_del_bt_for_a2_a5_0.ID AS COL0, __temp__Δ_del_bt_for_a2_a5_0.VID AS COL1, __temp__Δ_del_bt_for_a2_a5_0.LOCATION AS COL2, __temp__Δ_del_bt_for_a2_a5_0.RID AS COL3 
FROM __temp__Δ_del_bt_for_a2 AS __temp__Δ_del_bt_for_a2_a5_0 
WHERE __temp__Δ_del_bt_for_a2_a5_0.SHARABLE = 'True' AND NOT EXISTS ( SELECT * 
FROM (SELECT p_2_a5_0.COL1 AS COL0, p_2_a5_0.COL2 AS COL1, p_2_a5_0.COL3 AS COL2, p_2_a5_0.COL4 AS COL3 
FROM (SELECT __temp__Δ_ins_bt_for_a2_a5_0.SHARABLE AS COL0, __temp__Δ_ins_bt_for_a2_a5_0.ID AS COL1, __temp__Δ_ins_bt_for_a2_a5_0.LOCATION AS COL2, __temp__Δ_ins_bt_for_a2_a5_0.RID AS COL3, __temp__Δ_ins_bt_for_a2_a5_0.VID AS COL4 
FROM __temp__Δ_ins_bt_for_a2 AS __temp__Δ_ins_bt_for_a2_a5_0   UNION SELECT __temp__bt_for_a2_a5_0.SHARABLE AS COL0, __temp__bt_for_a2_a5_0.ID AS COL1, __temp__bt_for_a2_a5_0.LOCATION AS COL2, __temp__bt_for_a2_a5_0.RID AS COL3, __temp__bt_for_a2_a5_0.VID AS COL4 
FROM __temp__bt_for_a2 AS __temp__bt_for_a2_a5_0 
WHERE NOT EXISTS ( SELECT * 
FROM __temp__Δ_del_bt_for_a2 AS __temp__Δ_del_bt_for_a2_a5 
WHERE __temp__Δ_del_bt_for_a2_a5.SHARABLE = __temp__bt_for_a2_a5_0.SHARABLE AND __temp__Δ_del_bt_for_a2_a5.RID = __temp__bt_for_a2_a5_0.RID AND __temp__Δ_del_bt_for_a2_a5.LOCATION = __temp__bt_for_a2_a5_0.LOCATION AND __temp__Δ_del_bt_for_a2_a5.VID = __temp__bt_for_a2_a5_0.VID AND __temp__Δ_del_bt_for_a2_a5.ID = __temp__bt_for_a2_a5_0.ID ) ) AS p_2_a5_0 
WHERE p_2_a5_0.COL0 = 'True' ) AS p_1_a4 
WHERE p_1_a4.COL3 = __temp__Δ_del_bt_for_a2_a5_0.VID AND p_1_a4.COL2 = __temp__Δ_del_bt_for_a2_a5_0.RID AND p_1_a4.COL1 = __temp__Δ_del_bt_for_a2_a5_0.LOCATION AND p_1_a4.COL0 = __temp__Δ_del_bt_for_a2_a5_0.ID ) ) AS p_0_a4_0  ) AS ∂_del_a2_a4_0  ) AS __dummy__) as t);
        IF deletion_data IS NOT DISTINCT FROM NULL THEN 
            deletion_data := '[]';
        END IF; 
        IF (insertion_data IS DISTINCT FROM '[]') OR (deletion_data IS DISTINCT FROM '[]') THEN 
            ...
            IF NOT (user_name = 'dejima') THEN 
                ...
                json_data := concat('{"xid": "PeerC_', xid, '_a2" ,"view": ' , '"public.a2"', ', ' , '"insertions": ' , insertion_data , ', ' , '"deletions": ' , deletion_data , '}');
...
WHERE __temp__Δ_del_bt_for_a2_a5.SHARABLE = __temp__bt_for_a2_a5_0.SHARABLE AND __temp__Δ_del_bt_for_a2_a5.RID = __temp__bt_for_a2_a5_0.RID AND __temp__Δ_del_bt_for_a2_a5.LOCATION = __temp__bt_for_a2_a5_0.LOCATION AND __temp__Δ_del_bt_for_a2_a5.VID = __temp__bt_for_a2_a5_0.VID AND __temp__Δ_del_bt_for_a2_a5.ID = __temp__bt_for_a2_a5_0.ID ) ) AS p_2_a5_0 
WHERE p_2_a5_0.COL0 = 'True' ) AS p_1_a4 
WHERE p_1_a4.COL3 = __temp__Δ_del_bt_for_a2_a5_0.VID AND p_1_a4.COL2 = __temp__Δ_del_bt_for_a2_a5_0.RID AND p_1_a4.COL1 = __temp__Δ_del_bt_for_a2_a5_0.LOCATION AND p_1_a4.COL0 = __temp__Δ_del_bt_for_a2_a5_0.ID ) ) AS p_0_a4_0  ) AS ∂_del_a2_a4_0  ) AS __dummy__;
...
FROM __temp__bt_for_a2 AS __temp__bt_for_a2_a5_0 
WHERE __temp__bt_for_a2_a5_0.SHARABLE = 'True' ) AS p_1_a4 
WHERE p_1_a4.COL3 = __temp__Δ_ins_bt_for_a2_a5_0.VID AND p_1_a4.COL2 = __temp__Δ_ins_bt_for_a2_a5_0.RID AND p_1_a4.COL1 = __temp__Δ_ins_bt_for_a2_a5_0.LOCATION AND p_1_a4.COL0 = __temp__Δ_ins_bt_for_a2_a5_0.ID ) ) AS p_0_a4_0  ) AS ∂_ins_a2_a4_0  ) AS __dummy__;
            END IF;
        END IF;
    END IF;
END IF;
...
FROM (SELECT bt_a5_0.ID AS COL0, bt_a5_0.VID AS COL1, bt_a5_0.LOCATION AS COL2, bt_a5_0.RID AS COL3, bt_a5_0.SHARABLE AS COL4 
FROM public.bt AS bt_a5_0 
WHERE bt_a5_0.SHARABLE = 'True' AND NOT EXISTS ( SELECT * 
FROM (SELECT a2_a4_0.ID AS COL0, a2_a4_0.VID AS COL1, a2_a4_0.LOCATION AS COL2, a2_a4_0.RID AS COL3 
FROM public.a2 AS a2_a4_0 
WHERE NOT EXISTS ( SELECT * 
FROM __temp__Δ_del_a2 AS __temp__Δ_del_a2_a4 
WHERE __temp__Δ_del_a2_a4.RID = a2_a4_0.RID AND __temp__Δ_del_a2_a4.LOCATION = a2_a4_0.LOCATION AND __temp__Δ_del_a2_a4.VID = a2_a4_0.VID AND __temp__Δ_del_a2_a4.ID = a2_a4_0.ID )  UNION SELECT __temp__Δ_ins_a2_a4_0.ID AS COL0, __temp__Δ_ins_a2_a4_0.VID AS COL1, __temp__Δ_ins_a2_a4_0.LOCATION AS COL2, __temp__Δ_ins_a2_a4_0.RID AS COL3 
FROM __temp__Δ_ins_a2 AS __temp__Δ_ins_a2_a4_0  ) AS new_a2_a4 
WHERE new_a2_a4.COL3 = bt_a5_0.RID AND new_a2_a4.COL2 = bt_a5_0.LOCATION AND new_a2_a4.COL1 = bt_a5_0.VID AND new_a2_a4.COL0 = bt_a5_0.ID ) ) AS Δ_del_bt_a5_0  ) AS Δ_del_bt_extra_alias;
...
FROM (SELECT new_a2_a4_0.COL0 AS COL0, new_a2_a4_0.COL1 AS COL1, new_a2_a4_0.COL2 AS COL2, new_a2_a4_0.COL3 AS COL3, 'True' AS COL4 
FROM (SELECT a2_a4_0.ID AS COL0, a2_a4_0.VID AS COL1, a2_a4_0.LOCATION AS COL2, a2_a4_0.RID AS COL3 
FROM public.a2 AS a2_a4_0 
WHERE NOT EXISTS ( SELECT * 
FROM __temp__Δ_del_a2 AS __temp__Δ_del_a2_a4 
...
WHERE bt_a5.SHARABLE = 'True' AND bt_a5.RID = new_a2_a4_0.COL3 AND bt_a5.LOCATION = new_a2_a4_0.COL2 AND bt_a5.VID = new_a2_a4_0.COL1 AND bt_a5.ID = new_a2_a4_0.COL0 ) ) AS Δ_ins_bt_a5_0  ) AS Δ_ins_bt_extra_alia 
            EXCEPT 
            SELECT * FROM  public.bt; 

FOR temprecΔ_del_bt IN ( SELECT * FROM Δ_del_bt) LOOP 
            DELETE FROM public.bt WHERE ROW(ID,VID,LOCATION,RID,SHARABLE) =  temprecΔ_del_bt;
            END LOOP;
DROP TABLE Δ_del_bt;
...
AS $$
  ...
  BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
      ...
      END IF;
      DELETE FROM __temp__Δ_del_a2 WHERE ROW(ID,VID,LOCATION,RID) = NEW;
      INSERT INTO __temp__Δ_ins_a2 SELECT (NEW).*; 
    ELSIF TG_OP = 'UPDATE' THEN
      IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN 
        RAISE check_violation USING MESSAGE = 'Invalid update on view: view does not accept null value';
      END IF;
      DELETE FROM __temp__Δ_ins_a2 WHERE ROW(ID,VID,LOCATION,RID) = OLD;
