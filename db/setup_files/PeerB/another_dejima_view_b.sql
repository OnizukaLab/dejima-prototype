...
p_0(KEY, NAME) :- customer(KEY, NAME, _).
*/
...
FROM (SELECT customer_a3_0.KEY AS COL0, customer_a3_0.NAME AS COL1 
FROM public.customer AS customer_a3_0  ) AS p_0_a2_0  ) AS another_dejima_view_a2_0  ) AS __dummy__;
...
FROM (SELECT p_0_a2_0.COL0 AS COL0, p_0_a2_0.COL1 AS COL1 
FROM (SELECT __temp__Δ_ins_customer_a3_0.KEY AS COL0, __temp__Δ_ins_customer_a3_0.NAME AS COL1 
FROM __temp__Δ_ins_customer AS __temp__Δ_ins_customer_a3_0 
WHERE NOT EXISTS ( SELECT * 
FROM __temp__customer AS __temp__customer_a3 
WHERE __temp__customer_a3.NAME = __temp__Δ_ins_customer_a3_0.NAME AND __temp__customer_a3.KEY = __temp__Δ_ins_customer_a3_0.KEY ) ) AS p_0_a2_0  ) AS ∂_ins_another_dejima_view_a2_0  ) AS __dummy__) as t);
    IF insertion_data IS NOT DISTINCT FROM NULL THEN 
        insertion_data := '[]';
    END IF; 
...
FROM (SELECT p_0_a2_0.COL0 AS COL0, p_0_a2_0.COL1 AS COL1 
FROM (SELECT __temp__Δ_del_customer_a3_0.KEY AS COL0, __temp__Δ_del_customer_a3_0.NAME AS COL1 
FROM __temp__Δ_del_customer AS __temp__Δ_del_customer_a3_0 
WHERE NOT EXISTS ( SELECT * 
FROM (SELECT p_2_a3_0.COL1 AS COL0, p_2_a3_0.COL2 AS COL1 
FROM (SELECT __temp__Δ_ins_customer_a3_0.ADDRESS AS COL0, __temp__Δ_ins_customer_a3_0.KEY AS COL1, __temp__Δ_ins_customer_a3_0.NAME AS COL2 
FROM __temp__Δ_ins_customer AS __temp__Δ_ins_customer_a3_0   UNION SELECT __temp__customer_a3_0.ADDRESS AS COL0, __temp__customer_a3_0.KEY AS COL1, __temp__customer_a3_0.NAME AS COL2 
FROM __temp__customer AS __temp__customer_a3_0 
WHERE NOT EXISTS ( SELECT * 
FROM __temp__Δ_del_customer AS __temp__Δ_del_customer_a3 
WHERE __temp__Δ_del_customer_a3.ADDRESS = __temp__customer_a3_0.ADDRESS AND __temp__Δ_del_customer_a3.NAME = __temp__customer_a3_0.NAME AND __temp__Δ_del_customer_a3.KEY = __temp__customer_a3_0.KEY ) ) AS p_2_a3_0  ) AS p_1_a2 
WHERE p_1_a2.COL1 = __temp__Δ_del_customer_a3_0.NAME AND p_1_a2.COL0 = __temp__Δ_del_customer_a3_0.KEY ) ) AS p_0_a2_0  ) AS ∂_del_another_dejima_view_a2_0  ) AS __dummy__) as t);
    IF deletion_data IS NOT DISTINCT FROM NULL THEN 
        deletion_data := '[]';
    END IF; 
    IF (insertion_data IS DISTINCT FROM '[]') OR (deletion_data IS DISTINCT FROM '[]') THEN 
...
FROM __temp__Δ_del_customer AS __temp__Δ_del_customer_a3 
WHERE __temp__Δ_del_customer_a3.ADDRESS = __temp__customer_a3_0.ADDRESS AND __temp__Δ_del_customer_a3.NAME = __temp__customer_a3_0.NAME AND __temp__Δ_del_customer_a3.KEY = __temp__customer_a3_0.KEY ) ) AS p_2_a3_0  ) AS p_1_a2 
WHERE p_1_a2.COL1 = __temp__Δ_del_customer_a3_0.NAME AND p_1_a2.COL0 = __temp__Δ_del_customer_a3_0.KEY ) ) AS p_0_a2_0  ) AS ∂_del_another_dejima_view_a2_0  ) AS __dummy__;
...
WHERE NOT EXISTS ( SELECT * 
FROM __temp__customer AS __temp__customer_a3 
WHERE __temp__customer_a3.NAME = __temp__Δ_ins_customer_a3_0.NAME AND __temp__customer_a3.KEY = __temp__Δ_ins_customer_a3_0.KEY ) ) AS p_0_a2_0  ) AS ∂_ins_another_dejima_view_a2_0  ) AS __dummy__;
        END IF;
    END IF;
END IF;
RETURN NULL;
...
WHERE new_another_dejima_view_a2.COL1 = customer_a3_0.NAME AND new_another_dejima_view_a2.COL0 = customer_a3_0.KEY ) ) AS Δ_del_customer_a3_0  ) AS Δ_del_customer_extra_alias;
...
FROM (SELECT new_another_dejima_view_a2_0.COL0 AS COL0, new_another_dejima_view_a2_0.COL1 AS COL1, 'unknown' AS COL2 
FROM (SELECT another_dejima_view_a2_0.KEY AS COL0, another_dejima_view_a2_0.NAME AS COL1 
FROM public.another_dejima_view AS another_dejima_view_a2_0 
WHERE NOT EXISTS ( SELECT * 
FROM __temp__Δ_del_another_dejima_view AS __temp__Δ_del_another_dejima_view_a2 
...
WHERE customer_a3.NAME = new_another_dejima_view_a2_0.COL1 AND customer_a3.KEY = new_another_dejima_view_a2_0.COL0 ) ) AS Δ_ins_customer_a3_0  ) AS Δ_ins_customer_extra_alia 
            EXCEPT 
