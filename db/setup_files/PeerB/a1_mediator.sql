...
/*view definition (get):
a1(ID, VID, LOCATION, RID) :- p_0(ID, VID, LOCATION, RID).
p_0(ID, VID, LOCATION, RID) :- COL4 = 'A' , bt(ID, VID, LOCATION, RID, COL4).
*/
...
BEGIN
    ...
    END IF;
    DELETE FROM __temp__Δ_del_bt_for_a1 WHERE ROW(ID,VID,LOCATION,RID,PROVIDER) = NEW;
    INSERT INTO __temp__Δ_ins_bt_for_a1 SELECT (NEW).*; 
    ELSIF TG_OP = 'UPDATE' THEN
    IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN 
        RAISE check_violation USING MESSAGE = 'Invalid update: null value is not accepted';
    END IF;
    DELETE FROM __temp__Δ_ins_bt_for_a1 WHERE ROW(ID,VID,LOCATION,RID,PROVIDER) = OLD;
...
FROM (SELECT p_0_a4_0.COL0 AS COL0, p_0_a4_0.COL1 AS COL1, p_0_a4_0.COL2 AS COL2, p_0_a4_0.COL3 AS COL3 
FROM (SELECT __temp__Δ_ins_bt_for_a1_a5_0.ID AS COL0, __temp__Δ_ins_bt_for_a1_a5_0.VID AS COL1, __temp__Δ_ins_bt_for_a1_a5_0.LOCATION AS COL2, __temp__Δ_ins_bt_for_a1_a5_0.RID AS COL3 
FROM __temp__Δ_ins_bt_for_a1 AS __temp__Δ_ins_bt_for_a1_a5_0 
WHERE __temp__Δ_ins_bt_for_a1_a5_0.PROVIDER = 'A' AND NOT EXISTS ( SELECT * 
FROM (SELECT __temp__bt_for_a1_a5_0.ID AS COL0, __temp__bt_for_a1_a5_0.LOCATION AS COL1, __temp__bt_for_a1_a5_0.RID AS COL2, __temp__bt_for_a1_a5_0.VID AS COL3 
FROM __temp__bt_for_a1 AS __temp__bt_for_a1_a5_0 
WHERE __temp__bt_for_a1_a5_0.PROVIDER = 'A' ) AS p_1_a4 
WHERE p_1_a4.COL3 = __temp__Δ_ins_bt_for_a1_a5_0.VID AND p_1_a4.COL2 = __temp__Δ_ins_bt_for_a1_a5_0.RID AND p_1_a4.COL1 = __temp__Δ_ins_bt_for_a1_a5_0.LOCATION AND p_1_a4.COL0 = __temp__Δ_ins_bt_for_a1_a5_0.ID ) ) AS p_0_a4_0  ) AS ∂_ins_a1_a4_0  ) AS __dummy__) as t);
        IF insertion_data IS NOT DISTINCT FROM NULL THEN 
            insertion_data := '[]';
        END IF; 
...
FROM (SELECT p_0_a4_0.COL0 AS COL0, p_0_a4_0.COL1 AS COL1, p_0_a4_0.COL2 AS COL2, p_0_a4_0.COL3 AS COL3 
FROM (SELECT __temp__Δ_del_bt_for_a1_a5_0.ID AS COL0, __temp__Δ_del_bt_for_a1_a5_0.VID AS COL1, __temp__Δ_del_bt_for_a1_a5_0.LOCATION AS COL2, __temp__Δ_del_bt_for_a1_a5_0.RID AS COL3 
FROM __temp__Δ_del_bt_for_a1 AS __temp__Δ_del_bt_for_a1_a5_0 
WHERE __temp__Δ_del_bt_for_a1_a5_0.PROVIDER = 'A' AND NOT EXISTS ( SELECT * 
FROM (SELECT p_2_a5_0.COL1 AS COL0, p_2_a5_0.COL2 AS COL1, p_2_a5_0.COL3 AS COL2, p_2_a5_0.COL4 AS COL3 
FROM (SELECT __temp__Δ_ins_bt_for_a1_a5_0.PROVIDER AS COL0, __temp__Δ_ins_bt_for_a1_a5_0.ID AS COL1, __temp__Δ_ins_bt_for_a1_a5_0.LOCATION AS COL2, __temp__Δ_ins_bt_for_a1_a5_0.RID AS COL3, __temp__Δ_ins_bt_for_a1_a5_0.VID AS COL4 
FROM __temp__Δ_ins_bt_for_a1 AS __temp__Δ_ins_bt_for_a1_a5_0   UNION SELECT __temp__bt_for_a1_a5_0.PROVIDER AS COL0, __temp__bt_for_a1_a5_0.ID AS COL1, __temp__bt_for_a1_a5_0.LOCATION AS COL2, __temp__bt_for_a1_a5_0.RID AS COL3, __temp__bt_for_a1_a5_0.VID AS COL4 
FROM __temp__bt_for_a1 AS __temp__bt_for_a1_a5_0 
WHERE NOT EXISTS ( SELECT * 
FROM __temp__Δ_del_bt_for_a1 AS __temp__Δ_del_bt_for_a1_a5 
WHERE __temp__Δ_del_bt_for_a1_a5.PROVIDER = __temp__bt_for_a1_a5_0.PROVIDER AND __temp__Δ_del_bt_for_a1_a5.RID = __temp__bt_for_a1_a5_0.RID AND __temp__Δ_del_bt_for_a1_a5.LOCATION = __temp__bt_for_a1_a5_0.LOCATION AND __temp__Δ_del_bt_for_a1_a5.VID = __temp__bt_for_a1_a5_0.VID AND __temp__Δ_del_bt_for_a1_a5.ID = __temp__bt_for_a1_a5_0.ID ) ) AS p_2_a5_0 
WHERE p_2_a5_0.COL0 = 'A' ) AS p_1_a4 
WHERE p_1_a4.COL3 = __temp__Δ_del_bt_for_a1_a5_0.VID AND p_1_a4.COL2 = __temp__Δ_del_bt_for_a1_a5_0.RID AND p_1_a4.COL1 = __temp__Δ_del_bt_for_a1_a5_0.LOCATION AND p_1_a4.COL0 = __temp__Δ_del_bt_for_a1_a5_0.ID ) ) AS p_0_a4_0  ) AS ∂_del_a1_a4_0  ) AS __dummy__) as t);
        IF deletion_data IS NOT DISTINCT FROM NULL THEN 
            deletion_data := '[]';
        END IF; 
        IF (insertion_data IS DISTINCT FROM '[]') OR (deletion_data IS DISTINCT FROM '[]') THEN 
            ...
            IF NOT (user_name = 'dejima') THEN 
                ...
                json_data := concat('{"xid": "PeerB_', xid, '_a1" ,"view": ' , '"public.a1"', ', ' , '"insertions": ' , insertion_data , ', ' , '"deletions": ' , deletion_data , '}');
...
WHERE __temp__Δ_del_bt_for_a1_a5.PROVIDER = __temp__bt_for_a1_a5_0.PROVIDER AND __temp__Δ_del_bt_for_a1_a5.RID = __temp__bt_for_a1_a5_0.RID AND __temp__Δ_del_bt_for_a1_a5.LOCATION = __temp__bt_for_a1_a5_0.LOCATION AND __temp__Δ_del_bt_for_a1_a5.VID = __temp__bt_for_a1_a5_0.VID AND __temp__Δ_del_bt_for_a1_a5.ID = __temp__bt_for_a1_a5_0.ID ) ) AS p_2_a5_0 
WHERE p_2_a5_0.COL0 = 'A' ) AS p_1_a4 
WHERE p_1_a4.COL3 = __temp__Δ_del_bt_for_a1_a5_0.VID AND p_1_a4.COL2 = __temp__Δ_del_bt_for_a1_a5_0.RID AND p_1_a4.COL1 = __temp__Δ_del_bt_for_a1_a5_0.LOCATION AND p_1_a4.COL0 = __temp__Δ_del_bt_for_a1_a5_0.ID ) ) AS p_0_a4_0  ) AS ∂_del_a1_a4_0  ) AS __dummy__;
...
FROM __temp__bt_for_a1 AS __temp__bt_for_a1_a5_0 
WHERE __temp__bt_for_a1_a5_0.PROVIDER = 'A' ) AS p_1_a4 
WHERE p_1_a4.COL3 = __temp__Δ_ins_bt_for_a1_a5_0.VID AND p_1_a4.COL2 = __temp__Δ_ins_bt_for_a1_a5_0.RID AND p_1_a4.COL1 = __temp__Δ_ins_bt_for_a1_a5_0.LOCATION AND p_1_a4.COL0 = __temp__Δ_ins_bt_for_a1_a5_0.ID ) ) AS p_0_a4_0  ) AS ∂_ins_a1_a4_0  ) AS __dummy__;
            END IF;
        END IF;
    END IF;
END IF;
...
FROM (SELECT bt_a5_0.ID AS COL0, bt_a5_0.VID AS COL1, bt_a5_0.LOCATION AS COL2, bt_a5_0.RID AS COL3, bt_a5_0.PROVIDER AS COL4 
FROM public.bt AS bt_a5_0 
WHERE bt_a5_0.PROVIDER = 'A' AND NOT EXISTS ( SELECT * 
FROM (SELECT a1_a4_0.ID AS COL0, a1_a4_0.VID AS COL1, a1_a4_0.LOCATION AS COL2, a1_a4_0.RID AS COL3 
FROM public.a1 AS a1_a4_0 
WHERE NOT EXISTS ( SELECT * 
FROM __temp__Δ_del_a1 AS __temp__Δ_del_a1_a4 
WHERE __temp__Δ_del_a1_a4.RID = a1_a4_0.RID AND __temp__Δ_del_a1_a4.LOCATION = a1_a4_0.LOCATION AND __temp__Δ_del_a1_a4.VID = a1_a4_0.VID AND __temp__Δ_del_a1_a4.ID = a1_a4_0.ID )  UNION SELECT __temp__Δ_ins_a1_a4_0.ID AS COL0, __temp__Δ_ins_a1_a4_0.VID AS COL1, __temp__Δ_ins_a1_a4_0.LOCATION AS COL2, __temp__Δ_ins_a1_a4_0.RID AS COL3 
FROM __temp__Δ_ins_a1 AS __temp__Δ_ins_a1_a4_0  ) AS new_a1_a4 
WHERE new_a1_a4.COL3 = bt_a5_0.RID AND new_a1_a4.COL2 = bt_a5_0.LOCATION AND new_a1_a4.COL1 = bt_a5_0.VID AND new_a1_a4.COL0 = bt_a5_0.ID ) ) AS Δ_del_bt_a5_0  ) AS Δ_del_bt_extra_alias;
...
WHERE bt_a5.PROVIDER = 'A' AND bt_a5.RID = new_a1_a4_0.COL3 AND bt_a5.LOCATION = new_a1_a4_0.COL2 AND bt_a5.VID = new_a1_a4_0.COL1 AND bt_a5.ID = new_a1_a4_0.COL0 ) ) AS Δ_ins_bt_a5_0  ) AS Δ_ins_bt_extra_alia 
            EXCEPT 
            SELECT * FROM  public.bt; 

FOR temprecΔ_del_bt IN ( SELECT * FROM Δ_del_bt) LOOP 
            DELETE FROM public.bt WHERE ROW(ID,VID,LOCATION,RID,PROVIDER) =  temprecΔ_del_bt;
            END LOOP;
DROP TABLE Δ_del_bt;
...
AS $$
  ...
  BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
      ...
      END IF;
      DELETE FROM __temp__Δ_del_a1 WHERE ROW(ID,VID,LOCATION,RID) = NEW;
      INSERT INTO __temp__Δ_ins_a1 SELECT (NEW).*; 
    ELSIF TG_OP = 'UPDATE' THEN
      IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN 
        RAISE check_violation USING MESSAGE = 'Invalid update on view: view does not accept null value';
      END IF;
      DELETE FROM __temp__Δ_ins_a1 WHERE ROW(ID,VID,LOCATION,RID) = OLD;
