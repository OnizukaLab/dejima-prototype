...
p_0(ID, VID, LOCATION, RID) :- COL4 = 'C' , bt(ID, VID, LOCATION, RID, COL4).
*/
...
BEGIN
    ...
    END IF;
    DELETE FROM __temp__Δ_del_bt_for_a2 WHERE ROW(ID,VID,LOCATION,RID,PROVIDER) = NEW;
    INSERT INTO __temp__Δ_ins_bt_for_a2 SELECT (NEW).*; 
    ELSIF TG_OP = 'UPDATE' THEN
    IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN 
        RAISE check_violation USING MESSAGE = 'Invalid update: null value is not accepted';
    END IF;
    DELETE FROM __temp__Δ_ins_bt_for_a2 WHERE ROW(ID,VID,LOCATION,RID,PROVIDER) = OLD;
...
FROM (SELECT __temp__Δ_ins_bt_for_a2_a5_0.PROVIDER AS COL0, __temp__Δ_ins_bt_for_a2_a5_0.ID AS COL1, __temp__Δ_ins_bt_for_a2_a5_0.LOCATION AS COL2, __temp__Δ_ins_bt_for_a2_a5_0.RID AS COL3, __temp__Δ_ins_bt_for_a2_a5_0.VID AS COL4 
FROM __temp__Δ_ins_bt_for_a2 AS __temp__Δ_ins_bt_for_a2_a5_0   UNION SELECT __temp__bt_for_a2_a5_0.PROVIDER AS COL0, __temp__bt_for_a2_a5_0.ID AS COL1, __temp__bt_for_a2_a5_0.LOCATION AS COL2, __temp__bt_for_a2_a5_0.RID AS COL3, __temp__bt_for_a2_a5_0.VID AS COL4 
FROM __temp__bt_for_a2 AS __temp__bt_for_a2_a5_0 
...
WHERE p_1_a4.COL3 = __temp__Δ_del_bt_for_a2_a5_0.VID AND p_1_a4.COL2 = __temp__Δ_del_bt_for_a2_a5_0.RID AND p_1_a4.COL1 = __temp__Δ_del_bt_for_a2_a5_0.LOCATION AND p_1_a4.COL0 = __temp__Δ_del_bt_for_a2_a5_0.ID ) ) AS p_0_a4_0  ) AS ∂_del_a2_a4_0  ) AS __dummy__) as t);
        ...
        IF (insertion_data IS DISTINCT FROM '[]') OR (deletion_data IS DISTINCT FROM '[]') THEN 
            ...
            IF NOT (user_name = 'dejima') THEN 
                ...
                json_data := concat('{"xid": "PeerB_', xid, '_a2" ,"view": ' , '"public.a2"', ', ' , '"insertions": ' , insertion_data , ', ' , '"deletions": ' , deletion_data , '}');
...
WHERE bt_a5.PROVIDER = 'C' AND bt_a5.RID = new_a2_a4_0.COL3 AND bt_a5.LOCATION = new_a2_a4_0.COL2 AND bt_a5.VID = new_a2_a4_0.COL1 AND bt_a5.ID = new_a2_a4_0.COL0 ) ) AS Δ_ins_bt_a5_0  ) AS Δ_ins_bt_extra_alia 
            EXCEPT 
