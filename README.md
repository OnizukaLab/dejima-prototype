...
```
In this example, the migration class name is "Create<peer_name>Users", but you can define this class name arbitrarily. 
3. create files which define triggers, and add these files into peer/db/migrate.  These files call the SQL files generated by BIRDS. For example:
...
```
Same as before, you can define this migration class name arbitrarily.
4. create files which define models for base tables, and add these files into peer/app/models. For example:
```
require 'set'
